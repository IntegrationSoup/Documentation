...
Use it to archive messages, store exports or file content, or hand workflow output to downstream AWS-based processes.
...
3. Add **AWS S3 Upload** after the step that produces the content you want to upload.
...
Place the content you want stored in S3 into the activity message.
...
- Storing documents, binary exports, or DICOM files in S3
